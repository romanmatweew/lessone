...
def show_game_menu():
    ...
    ***********************************
    ...
    В этой захватывающей игре вы сможете
    проверить свои аналитические способности
    и интуицию, пытаясь отгадать секретное
    трехзначное число. Вы можете сыграть
    с друзьями или бросить вызов компьютеру.

    Приготовьтесь к увлекательной игре
    и весёлому времяпрепровождению!
    Удачи!
    """

    mode = input(welcome_message + "    Выберите режим игры:\n    1. Игра с другими игроками\n    2. Игра с компьютером\n    3. Выйти из игры\n    Ваш выбор: ")
    if mode == '1':
